  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white px-5 text-center">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-lg py-20">
        ...
        <p className="text-gray-900/50 text-sm mb-8 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full sm:w-auto h-12 px-8 bg-[#F5B400] text-[#0a1a0f] font-bold tracking-wide uppercase rounded-lg hover:bg-[#F5B400]/90 transition-all shadow-lg shadow-[#F5B400]/10 active:scale-[0.98]"
          >
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full sm:w-auto h-12 px-8 border border-gray-200 bg-gray-50 text-gray-900 font-semibold rounded-lg hover:bg-gray-100 hover:border-gray-300 transition-all active:scale-[0.98]"
          >
