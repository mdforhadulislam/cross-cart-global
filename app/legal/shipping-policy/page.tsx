    ...
    <div className="min-h-screen bg-[#0a1a0f] pt-12 pb-20 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-8 space-y-8">
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-white/5 rounded-xl p-4">
                ...
                <p className="text-white/50 text-sm">Fastest option for urgent shipments</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-white/50 text-sm">Standard air cargo service</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-white/50 text-sm">Cost-effective for large shipments</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold text-white mb-4">Shipping Process</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4">Packaging Requirements</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-4">Delivery Attempts</h2>
