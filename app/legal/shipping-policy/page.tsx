    ...
    <div className="min-h-screen bg-white pt-12 pb-20 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/5 border border-gray-200 rounded-2xl p-8 space-y-8">
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Delivery Timeframes</h2>
            <div className="space-y-4">
              <div className="bg-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  <Clock className="h-5 w-5 text-[#F5B400]" />
                  <h3 className="text-gray-900 font-semibold">Express Delivery</h3>
                  <span className="text-[#F5B400] text-sm">3-5 Business Days</span>
                </div>
                <p className="text-gray-900/50 text-sm">Fastest option for urgent shipments</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  <Truck className="h-5 w-5 text-blue-400" />
                  <h3 className="text-gray-900 font-semibold">Air Freight</h3>
                  <span className="text-blue-400 text-sm">7-10 Business Days</span>
                </div>
                <p className="text-gray-900/50 text-sm">Standard air cargo service</p>
              </div>
              <div className="bg-white/5 rounded-xl p-4">
                <div className="flex items-center gap-3 mb-2">
                  <Package className="h-5 w-5 text-green-400" />
                  <h3 className="text-gray-900 font-semibold">Sea Freight</h3>
                  <span className="text-green-400 text-sm">25-35 Business Days</span>
                </div>
                <p className="text-gray-900/50 text-sm">Cost-effective for large shipments</p>
              </div>
            </div>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Shipping Process</h2>
            <ol className="list-decimal list-inside text-gray-900/60 space-y-3 ml-4">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Packaging Requirements</h2>
            ...
            <ul className="list-disc list-inside text-gray-900/60 space-y-2 ml-4">
              ...
              <li>Label packages clearly with sender and recipient information</li>
              <li>Remove old shipping labels before sending</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">Delivery Attempts</h2>
            <p className="text-gray-900/60 leading-relaxed">
              If delivery is attempted and no one is available to receive the package, our courier 
              will leave a notification card. The package will be held at the nearest service point 
              for 7 days before being returned to sender.
            </p>
          </section>
