...
const FEATURES = [
  {
    ...
    desc: "Climate-controlled warehouses",
  },
  {
    icon: Shield,
  ...
  { icon: Truck, title: "Fulfillment", desc: "Pick, pack, and ship services" },
  {
    ...
    desc: "Multiple warehouse facilities",
  },
];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-white/50 max-w-2xl mx-auto">
            Secure, climate-controlled storage facilities for your business
            inventory. Complete fulfillment solutions to streamline your
            operations.
          </p>
        </div>
