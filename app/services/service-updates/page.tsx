...
const UPDATES = [
  ...
  { date: "Jan 10, 2024", title: "Extended Support Hours", desc: "Customer support now available until 10 PM" },
  { date: "Jan 5, 2024", title: "New Mobile App Features", desc: "Track shipments with enhanced UI" },
  { date: "Dec 28, 2023", title: "Holiday Schedule", desc: "Limited operations during Eid holidays" },
]
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F5B400]/10 border border-[#F5B400]/20 rounded-full mb-6">
            ...
            <span className="text-[#F5B400] text-sm font-medium">Latest News</span>
          </div>
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
            Service <span className="text-[#F5B400]">Updates</span>
          </h1>
          <p className="text-gray-900/50 max-w-2xl mx-auto">
            Stay informed about our latest service expansions, new features, and important announcements.
          </p>
        </div>

        <div className="space-y-4">
          {UPDATES.map((update, i) => (
            <div key={i} className="bg-white/5 border border-gray-200 rounded-xl p-6 flex gap-4">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-gray-900 font-semibold mb-1">{update.title}</h3>
                <p className="text-gray-900/50 text-sm">{update.desc}</p>
              </div>
            </div>
          ))}
        </div>
