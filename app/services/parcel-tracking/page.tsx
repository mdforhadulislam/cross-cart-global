    ...
    <div className="min-h-screen bg-white pt-12 pb-20 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/5 border border-gray-200 rounded-2xl p-8 mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4">How to Track</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {STEPS.map((step, i) => (
              <div key={i} className="text-center">
                ...
                <p className="text-gray-900/40 text-xs">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center">
          <Link href="/track" className="inline-flex items-center gap-2 px-8 py-4 bg-[#F5B400] text-[#0a1a0f] font-bold rounded-xl">
