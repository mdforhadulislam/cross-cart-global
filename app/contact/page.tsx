    ...
    <div className="min-h-screen bg-white pt-10 pb-10">
      <div className="max-w-7xl mx-auto px-5">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-gray-900/50 text-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            {/* Info Card */}
            <div className="bg-white/5 border border-gray-200 rounded-2xl p-6 lg:p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <p className="text-gray-900/40 text-xs uppercase tracking-wider font-bold mb-1">
                      Phone
                    </p>
                    <a
                      href="tel:+8801410144466"
                      className="text-gray-900 hover:text-[#F5B400] transition-colors font-medium"
                    >
                      +880 1410-144466
                    </a>
                    <br />
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900/30 text-sm mt-1">
          ...
          <div className="lg:col-span-8">
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 lg:p-10 shadow-2xl">
              {success ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center py-10 animate-fade-in">
                  ...
                  <p className="text-gray-900/50 max-w-sm">
                    Thank you for contacting Cross Cart. Our support team will
                    get back to you shortly.
                  </p>
                  <button
                    onClick={() => setSuccess(false)}
                    className="mt-6 text-[#F5B400] hover:text-gray-900 transition-colors text-sm font-semibold"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-900/80">
                        Full Name
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-900 placeholder:text-gray-900/20 focus:outline-none focus:border-[#F5B400]/50 focus:ring-1 focus:ring-[#F5B400]/50 transition-all"
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-900 focus:outline-none focus:border-[#F5B400]/50 focus:ring-1 focus:ring-[#F5B400]/50 transition-all appearance-none cursor-pointer"
                    >
                      <option value="" className="bg-white">
                        Select a topic
                      </option>
                      <option value="quote" className="bg-white">
                        Request a Quote
                      </option>
                      <option value="tracking" className="bg-white">
                        Tracking Issue
                      </option>
                      <option value="billing" className="bg-white">
                        Billing & Account
                      </option>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-900 placeholder:text-gray-900/20 focus:outline-none focus:border-[#F5B400]/50 focus:ring-1 focus:ring-[#F5B400]/50 transition-all resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto h-12 px-10 bg-[#F5B400] hover:bg-[#F5B400]/90 text-[#0a1a0f] font-bold tracking-wide uppercase rounded-lg transition-all flex items-center justify-center gap-2 disabled:opacity-70 shadow-lg shadow-[#F5B400]/10"
                  >
                    {loading ? (
...
// <div className="w-full rounded-2xl overflow-hidden border border-gray-200 h-100 relative group">
...
//             <div className="bg-white/90 backdrop-blur-md border border-[#F5B400]/30 p-6 rounded-2xl shadow-2xl text-center max-w-md mx-4 transform group-hover:scale-105 transition-transform duration-300">
...
//                   <MapPin className="h-6 w-6 text-[#0a1a0f]" />
//                 </div>
//               </div>
//               <h3 className="text-xl font-bold text-gray-900 mb-2">Cross Cart Global HQ</h3>
